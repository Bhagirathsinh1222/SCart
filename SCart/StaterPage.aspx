<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StaterPage.aspx.cs" Inherits="SCart.StaterPage" %>
...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/blog/SCart.png" rel="icon">
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
        <h1><a href="Login.aspx"><span>S</span>Cart</a></h1>
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url(assets/img/hero-carousel/1.jpg)">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">Don’t Just Buy... Buy Because</h2>
                <p class="animate__animated animate__fadeInUp">Your purchase here will catalyze change toward sustainable global business</p>
                <a href="Login.aspx" class="btn-get-started scrollto animate__animated animate__fadeInUp">View Product</a>
              </div>
            </div>
          </div>
          ...
          <div class="carousel-item" style="background-image: url(assets/img/hero-carousel/2.jpg)">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">Purchase With Purpose </h2>
                <p class="animate__animated animate__fadeInUp">Shop with your values among purpose driven vendors</p>
                <a href="#about" class="btn-get-started scrollto animate__animated animate__fadeInUp">Buy Now</a>
              </div>
            </div>
          </div>
          ...
          <div class="carousel-item" style="background-image: url(assets/img/hero-carousel/3.jpg)">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">Good for Business</h2>
                <p class="animate__animated animate__fadeInUp">Increase your social impact by gifting with our Catalyst Gift Card</p>
                <a href="#about" class="btn-get-started scrollto animate__animated animate__fadeInUp">Buy Now </a>
              </div>
            </div>
          </div>
