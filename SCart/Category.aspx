<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="SCart.Category" %>
            ...
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Button ID="BtnDelete" runat="server" Class="jogii" CommandArgument='<%# Eval("CategoryId") %>' CommandName="CategoryDelete" Text="Delete" />
                        ...
                        ControlToValidate="txtName" ErrorMessage="Name can not be blank." ValidationGroup="p1" 
                        SetFocusOnError="True"></asp:RequiredFieldValidator>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RFVtxtDetail" runat="server" ControlToValidate="txtDetails" ErrorMessage="* Please enter the Details" ForeColor="Red" SetFocusOnError="true" ValidationGroup="p1"></asp:RequiredFieldValidator>
                                    </div>
                            ...
                            <div class="row" style="margin: 15px">
                                    <div class="form-actions text-center">
                                        <div>
                                            <asp:Button ID="btnUpload" OnClick="btnUpload_Click" class="btn btn-info btn-sm" runat="server" Text="UPLOD" />
                                            <asp:Button ID="BtnSubmit"  OnClick="BtnSubmit_Click" ValidationGroup="p1" runat="server"  Text="SUBMIT" class="btn btn-info btn-sm"   />
                                        </div>
                                    </div>
